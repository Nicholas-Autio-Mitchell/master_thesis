...
def my_parser(elTree):
	...
	print('Length of parsed HTML data not equal: tweetID = %i, timestamps = %i, retweets = %i, favs = %i, usersName = %i, usersID = %i, texts = %i'
              % (len(tweetID), len(timestamps), len(retweets), len(favs), len(usersName), len(usersID), len(texts)))
...
# MAC    input_path = '/Volumes/Mac OS Drive/Thesis/Data/scrape_raw/'
input_path = "C:\\Users\\dev231\\Documents\\Thesis\\Data\\scrape_raw\\"
    
# MAC   output_path = "/Volumes/Mac OS Drive/Thesis/Data/sentiment_analysis/input/dirty/"
