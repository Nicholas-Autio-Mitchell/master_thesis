...
# Define the terms that we would like to search for (currently restricted to two)
search_term_1 = "\"bull"
search_term_2 = "market\""
...
#date_list = ['2015-09-15', '2015-09-01', '2015-08-15', '2015-08-01','2015-07-15', '2015-07-01', '2015-06-15', '2015-06-01', '2015-05-15', '2015-05-01', '2015-04-15', '2015-04-01', '2015-03-15', '2015-03-01', '2015-02-15', '2015-02-01', '2015-01-15', '2015-01-01', '2014-12-15', '2014-12-01', '2014-11-15', '2014-11-01', '2014-10-15', '2014-10-01','2015-09-15', '2015-09-01']
...
class Scraper:
    ...
    def iterator(self, end_date, start_date):
        ...
        print("+ Dates for session: " + start_date + " to " + end_date)
        ...
        time_this_scrape = time.time() - scrape_begin
        mins1, secs1 = divmod(time_this_scrape, 60)
        hrs1, mins1 = divmod(mins1, 60)
        days1, hrs1 = divmod(hrs1, 24)

        total_time_elapsed = time.time() - start_time
        mins2, secs2 = divmod(total_time_elapsed, 60)
        hrs2, mins2 = divmod(mins2, 60)
        days2, hrs2 = divmod(hrs2, 24)
        ...
        print("+ Duration of scroll sequence (D:HH:MM:SS): " + "%d:%02d:%02d:%02d" % (days1, hrs1, mins1, secs1))
        print("+ Accumulative time taken (D:HH:MM:SS): " + "%d:%02d:%02d:%02d" % (days2, hrs2, mins2, secs2))
...
print("+ Time taken (D:HH:MM:SS): " + "%d:%02d:%02d:%02d" % (days, hrs, mins, secs) + "\n")
