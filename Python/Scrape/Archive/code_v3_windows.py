...
class Sel(unittest.TestCase):
    def setUp(self):
        ...
        self.driver = webdriver.Firefox("C:/Program Files (x86)/Mozilla Firefox/firefox.exe")
    ...
    def test_sel(self):
        ...
        myFile = open("C:/Users/dev231/Dropbox/Thesis/PyCharm_Projects/2015-08-28_til_2015-08-30.txt", 'w')
