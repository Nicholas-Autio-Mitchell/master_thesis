...
all_results.bin.cutoff90.frame100 <- foreach(i = 1:length(input_data.one_list),
                                        .combine = append,
...
save(all_results.bin.cutoff90.frame100, file = paste0(this_folder, "/all_results.bin.cutoff90.frame100.rda"))
