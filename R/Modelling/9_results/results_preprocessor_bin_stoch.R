...
#base_path <- "/Volumes/Mac OS Drive/Documents/Dropbox/ultra/stochastic/"
...
## Inspect                                                                                                              
str(results_objects, max.level = 2)                                                                                     
                                                                                                                        
## get rid of the .rda suffixes on list elements                                                                        
...
x <- copy(results_objects$stoch_results.Lag.1.combined)
...
## Test object                                                                                                          
results_object <- results_objects$stoch_results.Lag.1.combined                                                          
...
sign_pred_accuracy <- function(results_object){
    ...
    predictive_power2 <- list("num_correct" = num_correct, "pct_accuracy" = sign_accuracy)
