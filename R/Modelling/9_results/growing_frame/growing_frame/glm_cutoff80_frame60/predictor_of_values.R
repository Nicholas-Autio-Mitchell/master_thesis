...
all_results.glm.cutoff80.frame60_growing <- foreach(i = 1:length(input_data.one_list),
                                            .combine = append,
                                            .packages = c("mboost", "caret", "data.table")) %dopar%
    {
        tmp_results <- ultra_model(input_data.one_list[[i]], nIter = 500,
                                   shrinkage = 0.1, frame_size = 60)
...
save(all_results.glm.cutoff80.frame60_growing, file = "all_results.glm.cutoff80.frame60_growing.rda")
