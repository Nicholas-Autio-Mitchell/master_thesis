...
all_results.bin.cutoff80.frame100 <- foreach(13 = 1:length(input_data.one_list),
                                        .combine = append,
...
save(all_results.bin.cutoff80.frame100, file = paste0(this_folder, "/all_results.bin.cutoff80.frame100.rda"))
