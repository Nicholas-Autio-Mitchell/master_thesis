...
all_results.bin.cutoff80.frame80 <- foreach(i = 19:length(input_data.one_list),
                                        .combine = append,
...
save(all_results.bin.cutoff80.frame80, file = paste0(this_folder, "/all_results.bin.cutoff80.frame80.rda"))
