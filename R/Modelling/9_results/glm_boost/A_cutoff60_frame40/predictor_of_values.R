...
all_results.glm.cutoff60.frame40 <- foreach(i = 1:length(input_data.one_list),
                                            .combine = append,
...
save(all_results.glm.cutoff60.frame40, file = "all_results.glm.cutoff60.frame40.rda")
