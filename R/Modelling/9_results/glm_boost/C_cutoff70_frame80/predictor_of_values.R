...
source(paste0(this_folder, "/corr_pruner_2.R"))
...
all_results.glm.cutoff70.frame80 <- foreach(i = 1:length(input_data.one_list),
                                            .combine = append,
...
save(all_results.glm.cutoff70.frame80, file = "all_results.glm.cutoff70.frame80.rda")

## was required as naming was wrong in actual run
