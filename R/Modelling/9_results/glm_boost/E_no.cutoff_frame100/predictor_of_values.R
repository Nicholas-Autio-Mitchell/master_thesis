...
all_results.glm.no_cutoff.frame100 <- foreach(i = 1:length(input_data.one_list),
                                            .combine = append,
...
save(all_results.glm.no_cutoff.frame100, file = "all_results.glm.no_cutoff.frame100.rda")
