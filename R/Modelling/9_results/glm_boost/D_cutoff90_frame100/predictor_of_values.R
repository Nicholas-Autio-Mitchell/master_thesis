...
all_results.glm.cutoff90.frame100 <- foreach(i = 1:length(input_data.one_list),
                                            .combine = append,
...
save(all_results.glm.cutoff90.frame100, file = "all_results.glm.cutoff90.frame100.rda")
