...
setwd("/Volumes/Mac OS Drive/Documents/Dropbox/Thesis/PyCharm_Projects/parsed")
file_name = "2014-10-30_til_2014-08-01.txt-parsed_with_user.txt"

# Read in the tab-separated files
...
## Get Dow
library(tseries)
x <- get.hist.quote(start = rng[1], end = rng[2], instrument = "^DJI",              provider = "yahoo", quote="Close")
