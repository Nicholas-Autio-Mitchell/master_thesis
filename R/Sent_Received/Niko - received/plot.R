...
print(load("/Volumes/Mac\ OS\ Drive/Documents/Dropbox/Thesis\ -\ Pre\ Github/R/Niko\ -\ sent\ to/data_dow.Rda"))           # taken from your data_dow.RData
...
x <- get.hist.quote(start=rng[1], end =rng[2], instrument = "^DJI",
                    provider = "yahoo", quote=c("AdjClose", "Open", "Close"))
##==========================================================
...
##==========================================================
par(mfrow=c(2,1))
plot(dm2, lwd=4, col=4, type="b", ylab="Frequency", main="'dow' Tweets")
plot(x,lwd=2, col=4, type="b",  ylab=c("AdjClose", "Open", "Close"), main ="Dow Jones")
